...
class CustomVJPTest(jtu.JaxTestCase):
  ...
  def test_symbolic_zero_custom_vjp(self, maybe_jit, maybe_vmap):
    ...
    # self.assertIsInstance(primal_out2, scalar_type)  # TODO DO NOT SUBMIT
...
class CustomVJP3Test(CustomVJPTest):
  ...
  # closure, do we care? let's try saying 'no'
  ...
  # def test_python_control_flow(self): pass  # TODO

  # error messages
  def test_missing_vjp_rule_error(self): pass  # TODO
